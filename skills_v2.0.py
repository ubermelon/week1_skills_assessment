...
def all_odd(number_list):
    ...
    return [each_number for each_number in number_list if each_number % 2 == 1]
...
def all_even(number_list):
    ...
    return [each_number for each_number in number_list if each_number % 2 == 0]
...
def long_words(word_list):
    ...
    return [each_word for each_word in word_list if len(each_word) > 4]
...
def halvesies(number_list):
    ...
    return [each_num / 2.0 for each_num in number_list]
...
def word_lengths(word_list):
    ...
    return [len(each_word) for each_word in word_list]
...
def mult_numbers(number_list):
    ...
    product_of_each_number = 1 # create a variable
    for each_number in number_list: # iterate through each number in the list
        product_of_each_number *= each_number # add each number and reassign the sum_of_each_number
    return product_of_each_number # return the total number
...
def join_strings(word_list):
    ...
    #     joined_word = reduce(lambda x,y:x+y,word_list)  
    #     if word_list == []:
    #         return ''
    # return joined_word
    ...
    every_word = ""
    for each_word in word_list:
        every_word = every_word + each_word
    return every_word

    # return [each_word + "." for each_word in word_list]
